                ...
                <form method="post" action="">
                    <div class="welcome">
                        ...
                        <?php 
                            ...
                            // else
                            // {
                                // $where="is_active='yes' && faculty='".$faculty."' && question_id='$qn+$sn-1'";
                            // }
                            //Old Query
                            //$where="is_active='yes'";
                            //$where = "is_active='yes' && faculty = '".$faculty"';
                            $limit=1;
                            $query=$obj->select_row($tbl_name,$where,$limit);
                        ...
                        <form method="post" action="">
                            ...
                            <div class="answers" >  
                                ...
                                <input type="radio" name="answer" value="1"  /> <span class="radio-ans"><?php echo $first_answer; ?></span>  <hr /><br />
                                <input type="radio" name="answer" value="2"  /> <span class="radio-ans"><?php echo $second_answer; ?></span> <hr /><br />
                                <input type="radio" name="answer" value="3"  /> <span class="radio-ans"><?php echo $third_answer; ?></span>  <hr /><br />
                                <input type="radio" name="answer" value="4"  /> <span class="radio-ans"><?php echo $fourth_answer; ?></span>  <hr /><br />
                                
                               
                                <textarea name="writing_answer" placeholder="Answer for writing"></textarea>
                                <script>
                        ...
                        <?php 
                            if(isset($_POST['submit']))
                            {
                                ...
                                if(isset($_POST['answer'], $_POST['writing_answer']))
                                {
                                    $user_answer=$obj->sanitize($conn,$_POST['answer']);
                                    $user_writing_answer=$obj->sanitize($conn,$_POST['writing_answer']);
                                }
                                else
                                {
                                    $user_answer=0;
                                    $user_writing_answer = null;
                                }
                                ...
                                user_writing_answer='$user_writing_answer',
