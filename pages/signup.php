            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <input type="text" name="wechat" placeholder="Wechat Number" required="true" /><br />
                        ...
                        <input type="text" name="grade" placeholder="Grade" required="true" /><br />

                        <span class="name">想补习的科目</span>
                        <input type="text" name="subjects" placeholder="英文，数学，科学。。。" required="true" /><br />
                        ...
                        <br />
                        -->
                        <input type="submit" name="submit" value="Submit" class="btn-add" style="margin-left: 15%;" />
