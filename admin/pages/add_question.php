            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms" enctype="multipart/form-data">
                        ...
                        <input type="text" name="first_answer" placeholder="First Answer"  /><br />
                        
                        <span class="name">Second Answer</span>
                        <input type="text" name="second_answer" placeholder="Second Answer"  /><br />
                        
                        <span class="name">Third Answer</span>
                        <input type="text" name="third_answer" placeholder="Third Answer"  /><br />
                        
                        <span class="name">Fourth Answer</span>
                        <input type="text" name="fourth_answer" placeholder="Fourth Answer"  /><br />
