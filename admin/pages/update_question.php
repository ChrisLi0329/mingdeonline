            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms" enctype="multipart/form-data">
                        ...
                        <input type="text" name="first_answer" value="<?php echo $first_answer;; ?>"  /><br />
                        
                        <span class="name">Second Answer</span>
                        <input type="text" name="second_answer" value="<?php echo $second_answer; ?>"  /><br />
                        
                        <span class="name">Third Answer</span>
                        <input type="text" name="third_answer" value="<?php echo $third_answer; ?>"  /><br />
                        
                        <span class="name">Fourth Answer</span>
                        <input type="text" name="fourth_answer" value="<?php echo $fourth_answer; ?>"  /><br />
                        ...
                        <span class="name">Writing_answer</span><br />
                        <textarea name="writing_answer" ><?php echo $writing_answer; ?></textarea>
                        <script>
                        ...
                        <select name="category">
                            <option <?php if($category=="multipleChoice"){echo "selected='seleccted'";} ?> value="multipleChoice">Multiple Choice</option>
                            <option  <?php if($category=="writing"){echo "selected='seleccted'";} ?> value="writing">Writing</option>
                        </select>
                        <br />
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            $writing_answer=$obj->sanitize($conn,$_POST['writing_answer']);
